...
用 PostPress 将 Markdown 渲染为微信公众号编辑器兼容的富文本 HTML，支持图片、代码高亮、Mermaid 流程图、表格等全部特性。
...
PostPress 使用 highlight.js 进行语法高亮，支持 180+ 种语言。以下是几种常见语言的效果：
...
链接也有特殊样式：访问 [PostPress 项目](https://github.com/liustack/postpress) 了解更多。
...
1. 编写 Markdown 源文件
2. 运行 `postpress -i input.md -o output.html`
3. 复制 HTML 到微信编辑器
4. 预览效果，调整细节
5. 发布文章
...
PostPress 支持 GFM 脚注语法[^1]。脚注内容会在文章底部显示[^2]，并且链接会被转换为微信编辑器兼容的格式[^3]。
